"""The team roster from §3.2. Served by GET /users and injected into the
classifier prompt so scopes are defined in exactly one place."""
...
NAME_BY_ID = {m["user_id"]: m["name"] for m in TEAM}
